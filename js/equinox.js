...
(function($) {
	...
	var getMonthHtml = function(month, events) {
		...
		var header = $('<div class="calendar-header bg-secondary"></div>');
		header.append('<div class="month-label">' + month.format('MMMM YYYY') + '</div>');
		header.append('<div class="calendar-actions"></div>');
		$('.calendar-actions', header).append('<button type="button" class="prev btn btn-info m-1">Prethodni mesec</button> ');
		$('.calendar-actions', header).append('<button type="button" class=" next btn btn-info m-1">Naredni mesec</button> ');
		$('.calendar-actions', header).append('<button type="button" class=" today btn btn-info m-1">Danas</button> ');
